...
local function LoadAssassinSheriffMobile()
    ...
    local function CreateMobileControls()
        ...
        aimButton.Size = UDim2.new(0, 120, 0, 120)
        aimButton.Position = UDim2.new(1, -140, 1, -280)
        aimButton.BackgroundColor3 = Color3.fromRGB(60, 120, 255)
    ...
    -- ========== Rayfieldウィンドウ作成 ==========
    local Window = Rayfield:CreateWindow({
       Name = "暗殺者対保安官2 v3 | モバイル版 | @syu_u0316",
       LoadingTitle = "超高密度射撃システム - モバイル",
       LoadingSubtitle = "10層技術実装版 - タッチ操作最適化",
       ConfigurationSaving = {
          Enabled = true,
          FolderName = "AssassinSheriff2_Mobile",
          FileName = "config"
       },
       Discord = {
          Enabled = false,
    ...
    Rayfield:Notify({
       Title = "モバイル版 読み込み完了",
       Content = "暗殺者対保安官2 v3 - タッチ操作最適化版\nセキュリティ突破済み",
       Duration = 5,
       Image = nil,
    })

    log("========================================")
    log("  暗殺者対保安官2 超高密度射撃 v3 - モバイル版")
    log("  作者: @syu_u0316")
    log("  セキュリティ突破済み")
    log("  タッチコントロール有効")
    log("========================================")
